...
(async () => {
  ...
  await page.goto('https://8080-bceafcceaddaddfcacbbbbfcabfbafe.examlyiopb.examly.io');
  ...
  await page1.goto('https://8081-bceafcceaddaddfcacbbbbfcabfbafe.examlyiopb.examly.io');
